...
admin.site.index_title = "TECH BLOG  Admin Panel"
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user_id','user', 'first_name', 'last_name', 'email','gender','phone_number', 'country', 'profile_picture', 'date_created', 'date_updated')
